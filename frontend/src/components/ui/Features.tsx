...
const FeatureCard = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <motion.div 
      className={`group ${sizeClasses[feature.size || "small"]} h-full`} 
        ...
        <div className="relative flex justify-center">
          <img 
           ...
           alt="karn"
            ...
            className="rounded xl shadow-9xl"
          />
        </div>
      </div>
    </motion.div>
...
const Features = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-gray-100 to-gray-200 dark:from-black dark:to">
