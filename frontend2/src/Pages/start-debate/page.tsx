  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-4">
      ...
      >
        ...
        <div className="mb-6">
          <div className="relative">
            <Input
              ...
              className="pl-10 pr-4 py-2 w-full border-2 border-gray-300 rounded-lg focus:border-black transition-all duration-300"
            />
            ...
            {topics.map((category) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-50 ${
                  activeTab === category.category ? "bg-gray-300" : ""
                }`}
              >
                {category.category}
              </button>
        ...
        {/* Custom Topic Input */}
        <div className="mb-6">
          <Label htmlFor="customTopic" className="text-lg text-gray-700 mb-2 block">
          ...
          <div className="flex items-center">
            <Input
              ...
              className="flex-grow mr-2 border-2 border-gray-300 focus:border-black transition-all duration-300"
            />
            <Button
              onClick={() => {
                setSelectedTopic("custom");
